...
import { AuthLogin, authLoginSchema } from "@/models/Auth";
import {
  Field,
  FieldError,
  FieldGroup,
  FieldLabel,
} from "@/components/lib/ui/field";
...
export default function SignInForm() {
  ...
  const { mutateAsync, isError, error } = usePostLogin();
                ...
                <FieldGroup>
                  <Controller
                    ...
                    render={({ field, fieldState }) => (
                      ...
                      >
                        <FieldLabel htmlFor="form-signin-username">
                          Username{" "}
                          <span className="text-error-500">*</span>{" "}
                        </FieldLabel>
                        <Input
                          {...field}
                          id="form-signin-username"
